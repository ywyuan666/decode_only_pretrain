...
def train(optimizer_name='adamw', total_steps=40000, batch_size=4, resume=False):
    ...
    if resume and os.path.exists(ckpt_path):
        ...
        # ✅ 已从 8000 步训练到 20000 步，所以这里改为 20000
        start_step = 20000
    ...
    # 学习率调度参数，适应新的 total_steps (例如 40000)
    warmup_steps = 200
    plateau_steps = int(total_steps * 0.25)  # 例如 40000 -> 10000
...
if __name__ == "__main__":
    ...
    # 续训时自动设置总步数为 40000（你也可手动指定）
    target_steps = 40000
    train(opt, total_steps=target_steps, resume=resume)